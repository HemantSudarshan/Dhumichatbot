...
description: "Secure backend coding practices. Use when hardening server code against injection, SSRF, path traversal, deserialization attacks, and other backend vulnerabilities."
---
