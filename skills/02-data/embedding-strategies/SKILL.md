...
description: "Select and optimize embedding models for AI applications. Use when choosing between sentence-transformers, OpenAI embeddings, or domain-specific models for search and retrieval."
---
