---
name: langgraph
description: "Build stateful, graph-based agent workflows with LangGraph. Use when implementing agents with conditional branching, human-in-the-loop checkpoints, or persistent state."
---
